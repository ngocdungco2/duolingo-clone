...
export const courses = pgTable("courses", {
  // serial là tự động tăng
  id: serial("id").primaryKey(),
  title: text("title").notNull(),
  imageSrc: text("image_src").notNull(),
});
//tạo mối quan hệ 1 courses với userProgress
export const coursesRelations = relations(courses, ({ many }) => ({
  userProgress: many(userProgress),
  units: many(units),
}));
//1 khóa học có thể có nhiều unit nhưng unit thì chỉ có 1 khóa học
...
// mỗi thử thách sẽ có nhiều lựa chọn nhưng mỗi lựa chọn chỉ thuộc về 1 thử thách
...
// tạo mỗi quan hệ 1 v 1 giữa người dùng vào môn học
